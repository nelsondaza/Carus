...
<head>
	<?= $this->load->view('admin/head', array('title' => lang('users_page_name')) ) ?>
</head>
<body>
<?= $this->load->view('admin/header') ?>
<div class="container content">
	<?= $this->load->view('admin/menu', array('current' => 'manage_users') ) ?>
...
<?
	...
	if ( !empty($errors) ) {
		...
		$this->load->view('admin/message', array('content' => lang("users_{$action}_description") ) );
	}
?>
