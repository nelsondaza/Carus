...
<head>
	<?= $this->load->view('admin/head', array('title' => lang('settings_page_name')) ) ?>
</head>
<body>
<?= $this->load->view('admin/header') ?>
<div class="container content">
	<?= $this->load->view('admin/menu', array('current' => 'account_settings') ) ?>
...
<?
	...
	if ( !empty($errors) ) {
		...
		$this->load->view('admin/message', array('type' => 'success','class' => 'info','content' => $settings_info) );
	}
	else {
		$this->load->view('admin/message', array('class' => 'lock','content' => sprintf(lang('settings_privacy_statement'), anchor('page/privacy-policy', lang('settings_privacy_policy'))) ) );
	}
?>
