...
<head>
	<?= $this->load->view('admin/head', array('title' => lang('profile_page_name')) ) ?>
</head>
<body>
<?= $this->load->view('admin/header') ?>
<div class="container content">
	<?= $this->load->view('admin/menu', array('current' => 'account_profile') ) ?>
...
<?
	...
	if ( !empty($errors) ) {
		...
		$this->load->view('admin/message', array('type' => 'success','class' => 'info','content' => $profile_info) );
	}
	else {
		$this->load->view('admin/message', array('class' => 'unlock','content' => lang('profile_instructions')) );
	}
?>
