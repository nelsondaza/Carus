...
<head>
	<?= $this->load->view('admin/head', array('title' => lang('permissions_page_name')) ) ?>
</head>
<body>
<?= $this->load->view('admin/header') ?>
<div class="container content">
	<?= $this->load->view('admin/menu', array('current' => 'manage_permissions') ) ?>
	<div class="sub-header"><i class="privacy icon"></i> <?= lang("permissions_{$action}_page_name") ?></div>
	<div class="section">
<?
    echo $this->load->view( 'admin/breadcrumb', array(
        'path' => array(
	...
	if ( !empty($errors) ) {
		...
		$this->load->view('admin/message', array('content' => lang("permissions_{$action}_description") ) );
	}
?>
