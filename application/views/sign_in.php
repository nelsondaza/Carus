...
<head>
<?= $this->load->view('admin/head', array('title' => lang('sign_in_page_name'))) ?>
</head>
<body class="clean">
<?= $this->load->view('admin/header') ?>
<div class="container">
	<div class="container-login">
		<?= form_open(uri_string().($this->input->get('continue') ? '/?continue='.urlencode($this->input->get('continue')) : ''), 'class="ui inverted form ' . ( isset( $sign_in_error ) || isset( $sign_in_username_email_error ) || validation_errors() ? 'error' : '' ) . '"'); ?>
