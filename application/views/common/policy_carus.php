<h1><img src="resources/img/logo-shadow.png"></h1>

<div id="left_column" class="left_column legal legal-content">
	<h1 class="corp_page_title">
		<span class="title">Terms of Service</span>
		<span class="updated">Last Modified: 2014-01-27</span>
	</h1>

	<div class="annotation inside">Tumblr is a U.S. company and subject only to U.S. laws and jurisdiction, so for the moment these Terms of Service (and any other terms, policies, or guidelines that we provide to you) are only available in English.</div>
	<p class="opening">
		Hello! Welcome to Tumblr’s Terms of Service. Please read this carefully before using our site, services, or products. This is a contract between you and Tumblr. We've also included several annotations that aren't a part of the contract itself, but are intended to emphasize key sections and help you follow the text. We’ve tried to be fair and straightforward. Please feel free to
		<a href="/support">contact us</a> if you have any questions or suggestions!
	</p>

	<h2>1. Accepting the Terms of Service</h2>

	<p>
		Please read these Terms of Service and our
		<a href="/policy/community">Community Guidelines</a> (collectively, the "<b>Agreement</b>") carefully before using tumblr.com (the "<b>Site</b>") and/or the other domains, websites, products, applications, mobile applications, services, and/or Content provided by Tumblr, Inc. (all of those collectively with the Site, the "<b>Services</b>") (Tumblr, Inc., a Delaware corporation and wholly-owned subsidiary of Yahoo! Inc., a Delaware corporation, collectively with its agents, representatives, consultants, employees, officers, and directors, "<b>Tumblr</b>," "<b>we</b>," or "<b>us</b>"). By using or accessing the Services, you ("<b>Subscriber</b>" or "<b>you</b>") agree to be bound by all the terms and conditions of this Agreement. If you don’t agree to all the terms and conditions of this Agreement, you shouldn't, and aren't permitted to, use the Services.
	</p>

	<div class="annotation inside">We’re just letting you know, here, that we were recently acquired by Yahoo! Inc. This section also includes an agreement where you're agreeing to agree to the terms of this agreement.</div>
	<p></p>
	...
	<div class="annotation inside">As Tumblr grows and improves, we might have to make changes to these Terms of Service. When we do, we'll let you know. We're also going to make it a practice to post old versions so it's easy to see changes/additions/deletions. To see old versions, scroll down to the end of this document.</div>
	<p></p>
	...
	<div class="annotation inside">You have to be at least 13 years old to use Tumblr. We're serious: it's a hard rule, based on U.S. federal and state legislation. “But I’m, like, 12.9 years old!” you plead. Nope, sorry. If you're younger than 13, don't use Tumblr. Ask your parents for a Playstation 4, or try books.</div>
	<p></p>
	...
	<div class="annotation inside">Tumblr is an ever-evolving platform. With new products, services, and features launching all the time, we need flexibility to make changes, impose limits, and occasionally suspend or terminate certain offerings (like features that flop). We can also terminate or suspend any account at any time. That sounds harsh, but we only use that power when we have a reason, as outlined in these Terms of Service, our
		<a href="/policy/privacy">Privacy Policy</a>, and our
		<a href="/policy/community">Community Guidelines</a>.
	</div>
	<p></p>

	<h3>Limitations on Automated Use:</h3>
	...
	<div class="annotation inside">Don't do bad things to Tumblr or to other users. Some particularly egregious examples of "bad things" are listed in this section.</div>
	<p></p>

	<h2>4. Registration, Tumblr URLs, and Security</h2>

	<p>
		As a condition to using certain of the Services, you may be required to create an account (an "<b>Account</b>") and select a password and Tumblr username, which will serve as a default link to your default Tumblr blog of the form [username].tumblr.com (a "<b>Tumblr URL</b>"). You must select a different Tumblr URL for each new blog you create.
	</p>
	...
	<div class="annotation inside">It's really important that the email address associated with your Tumblr account is accurate and up-to-date. If you ever forget your password - or worse, fall victim to a malicious phishing attack - a working email address is often the only way for us to recover your account.</div>
	<p></p>
	...
	<p>
		For information about how Tumblr collects, uses, and shares your information, please review our
		<a href="/policy/privacy">Privacy Policy</a>. You agree that by using the Services you consent to the collection, use, and sharing (as set forth in the Privacy Policy) of such information, including the transfer of this information to the United States and/or other countries for storage, processing, and use by Tumblr and the Tumblr Affiliates (as defined below).
	</p>

	<h2>6. Content and Subscriber Content</h2>

	<h3>Definitions:</h3>

	<p>
		For purposes of this Agreement: (1) the term "<b>Content</b>" means a creative expression and includes, without limitation, video, audio, photographs, images, illustrations, animations, logos, tools, written posts, replies, comments, information, data, text, software, scripts, executable files, graphics, Themes (as defined below), and interactive features, any of which may be generated, provided, or otherwise made accessible on or through the Services; (2) the term "<b>Subscriber Content</b>" means Content that a Subscriber submits, transfers, or otherwise provides to the Services. Content includes, without limitation, all Subscriber Content.
	</p>

	<h3>Your Rights in Subscriber Content:</h3>
	...
	<div class="annotation inside">An example of what it means to "make all publicly-posted Content available" to a Tumblr partner for distribution or analysis would be licensing the Tumblr "firehose," a live feed of all public activity on Tumblr, to partners like search engines.</div>
	<p></p>
	...
	<div class="annotation inside">One thing you should consider before posting: When you make something publicly available on the Internet, it becomes practically impossible to take down all copies of it.</div>
	<p></p>
	...
	<h3>Compliance with Community Guidelines:</h3>

	<p>
		You agree that you won't violate Tumblr's
		<a href="/policy/community">Community Guidelines</a>.
	</p>

	<h3>Termination and Deletion:</h3>
	...
	<h2>7. Special Provisions for Application Developers</h2>

	<p>
		If you develop software or services based on the Services or any Content, whether using the
		<a href="http://www.tumblr.com/developers">Tumblr Application Programming Interface</a> or not, you will agree to and comply with the
		<a href="/docs/api_agreement">Tumblr Application Developer and API License Agreement</a>.
	</p>

	<h2>8. Use of Trademarks</h2>

	<p>
		Any use of Tumblr's trademarks, branding, logos, and other such assets in connection with the Services shall use
		<a href="http://www.tumblr.com/logo">Tumblr’s approved branding</a> and shall be in accordance with the
		<a href="http://www.tumblr.com/docs/trademark_guidelines">Tumblr Trademark Guidelines</a>.
	</p>

	<h2>9. Themes</h2>

	<p>
		Tumblr makes available specialized HTML and CSS code ("<b>Tumblr Template Code</b>") for the design and layout of blog pages available for use on some of the Services ("<b>Themes</b>"). Certain Themes are available for purchase as a Paid Service (as defined below) (such Themes, "<b>Premium Themes</b>"). Purchased Premium Themes may not be transferred between Accounts, between blogs, or between Services on a single Account and are subject to the payment terms herein.
	</p>

	<p>
		Tumblr grants you a license to customize the Tumblr Template Code to create your own Themes for use on your blog page (each a "<b>Custom Theme</b>"). If you choose, you may also contribute your Custom Themes for use by other Subscribers as Subscriber Content. However, as a condition of this license allowing you to create Custom Themes, you agree that you won't distribute such Custom Themes from locations other than Tumblr-owned or approved websites without our permission, as set out in our
		<a href="/policy/community">Community Guidelines</a>.
	</p>
	...
	<p>
		To develop and distribute Custom Themes that are Premium Themes, please
		<a href="/support">contact us</a>.
	</p>

	<h2>10. Paid Services</h2>

	<p>
		Some of the Services require payment of fees (the "<b>Paid Services</b>," including without limitation Premium Themes). All fees are stated in United States dollars. You shall pay all applicable fees, as described in the applicable Services, in connection with such Services, and any related taxes or additional charges.
	</p>
	...
	<h2>11. Special Provisions for Promotions</h2>

	<p>
		Some features of the Services may allow you to promote yourself to other Subscribers, and some of these features may be Paid Services ("<b>Promotions</b>").
	</p>
	...
	<ul>
		<li>Things that you promote will comply with this Agreement; if they don't, Tumblr reserves the right, in its sole discretion, to cancel a Promotion without refund or recourse to you.</li>
		<li>Tumblr may remove or disable any Promotion for any reason in its sole discretion.</li>
		<li>Unless otherwise specified, Tumblr does not guarantee any activity that Promotions may receive, including but not limited to clicks, Likes, and Reblogs. Tumblr cannot control how Subscribers interact with Promotions and is not responsible for "click fraud" or other fraudulent actions by third parties, including, without limitation, Subscribers. Tumblr doesn't guarantee that its reporting related to Promotions will be accurate or complete, nor does it guarantee that Promotions will behave in a particular manner, and Tumblr shall not be liable to you or responsible for any erroneous reporting about or errant behavior of or related to Promotions (e.g., any errors in how Likes or Reblogs are counted).
		</li>
		<li>Promotions may allow targeting to some Subscriber characteristics. Tumblr does not guarantee that any particular Promotion will reach a particular sort of individual in all cases.</li>
		<li>You can cancel certain Promotions at any time depending on their functionality, but you are responsible for paying for Promotions at least to the extent they have already been used or distributed through the Services.</li>
		<li>By submitting a Promotion, you license Tumblr to run that Promotion for as long as you have specified, which, depending on the Promotion, may be perpetually. This license ends when the Promotion has been completed or cancelled, but it may take up to forty eight (48) hours for a Promotion to stop being reflected on the Services.</li>
	</ul>
	<h2>12. Warranty Disclaimer; Services Available on an "AS IS" Basis</h2>
	...
	<h2>13. Time Limitation on Claims and Releases From Liability</h2>
	...
	<ul>
		...
		<li>The acts of third parties generally (i.e., individuals or entities who are not Tumblr or a Tumblr Affiliate), including third party sites and services.</li>
		...
		<li>Claims relating to any face-to-face meetings in any way related to Tumblr at any venues ("<b>Meetups</b>"), including without limitation claims related to the actions or omissions of any Subscribers or third parties who organize, attend, or are otherwise involved in any Meetups; see our
			<a href="/meetups">Meetups page</a> for more information. Unless otherwise expressly disclosed in writing, Tumblr does not sponsor, oversee, or in any manner control Meetups.
		</li>
	</ul>
	<p>
	...
	<h2>15. Exclusions to Warranties and Limitation of Liability</h2>
	...
	<h2>17. Choice of Law and Venue</h2>

	<p>
		You and Tumblr agree that we will resolve any claim or controversy at law or equity that arises out of this Agreement or the Services in accordance with this Section or as you and Tumblr otherwise agree in writing. Before resorting to formal dispute resolution, we strongly encourage you to
		<a href="/support">contact us</a> to seek a resolution.
	</p>

	<h3>Law and Forum for Legal Disputes:</h3>
	...
	<p>
		...
		<i>Tumblr, Inc., 35 East 21st Street, Ground Floor, New York, NY, 10010, Attn: Legal Department</i>.
	</p>

	<h2>19. Special Provisions for Subscribers Located Outside of the United States</h2>
	...
	<div>
		<div style="position: absolute; right: 0; bottom: 23px;">
			<a href="/dmca" class="chrome" style="line-height: 24px; height: 25px; padding: 0 7px; margin-top: 3px;">Submit an infringement notice</a>
		</div>
		<h2 id="dmca">20. DMCA Copyright Policy</h2></div>
	<p>
		Tumblr has adopted the following policy toward copyright infringement on the Services in accordance with the
		<a href="http://www.loc.gov/copyright/legislation/dmca.pdf">Digital Millennium Copyright Act</a> (the "<b>DMCA</b>"). The address of Tumblr's Designated Agent for copyright takedown notices ("<b>Designated Agent</b>") is listed below. You may submit a notice under the DMCA using our
		<a href="http://www.tumblr.com/dmca">copyright notice form</a>.
	</p>

	<h3>Reporting Instances of Copyright Infringement:</h3>
	...
	<ol>
		...
		<li>Identification of the material that is claimed to be infringing, including its location, with sufficient detail so that Tumblr is capable of finding it and verifying its existence.</li>
	...
	<ul>
		<li>The specific URLs of material that Tumblr has removed or to which Tumblr has disabled access.</li>
		<li>Your name, address, telephone number, and email address.</li>
		<li>A statement that you consent to the jurisdiction of Federal District Court for the judicial district in which your address is located (or the federal district courts located in New York County, New York if your address is outside of the United States), and that you will accept service of process from the person who provided the original DMCA notification or an agent of such person.</li>
	...
	<p>
		Tumblr, Inc.<br>
		35 East 21st St, Ground Floor<br>
		New York, NY 10010<br><b>Attn:</b> Copyright Agent<br><b>Fax:</b> +1 (646) 513-4321<br><b>Email:</b>
		<a href="mailto:dmca@tumblr.com?body=%0A%0A----------------------------------%0APlease%20do%20not%20delete%20this%20information.%20It%20will%20help%20Tumblr%20address%20your%20issue.%0APlease%20include%20your%20Tumblr%20URL%20and%20the%20email%20attached%20to%20your%20account%20in%20your%20message.%0AIP%20Address%3A%20%20186.84.141.120%0ABrowser%3A%20%20Mozilla%2F5.0%20%28Macintosh%3B%20Intel%20Mac%20OS%20X%2010_11_1%29%20AppleWebKit%2F537.36%20%28KHTML%2C%20like%20Gecko%29%20Chrome%2F46.0.2490.80%20Safari%2F537.36%0A----------------------------------">dmca@tumblr.com</a><br><b>Copyright notice form:</b>
		<a href="http://www.tumblr.com/dmca">http://www.tumblr.com/dmca</a></p>

	<h2>21. Open Source Disclosures</h2>
	...
	<ul>
		<li>
			<a href="http://www.tumblr.com/policy/ios-credits">http://www.tumblr.com/policy/ios-credits</a>
		</li>
		<li>
			<a href="http://www.tumblr.com/policy/android-credits">http://www.tumblr.com/policy/android-credits</a>
		</li>
		<li>
			<a href="http://www.tumblr.com/policy/web-credits">http://www.tumblr.com/policy/web-credits</a>
		</li>
	</ul>
</div>
