	...
	<section class="section-4">
		<div class="body-zone">
			<div class="steps-list">
				<div class="steps">
					<h1>
						<img class="desktop" src="/images/steps-hash.png" align="The ZPump" />
						<img class="mobile" src="/images/steps-hash-m.png" align="The ZPump" />
					</h1>
					<div class="step">
						<img src="/images/step-1.jpg">
						<p>REALIZA COMPRAS entre el 6 de agosto y el 14 de septiembre de 2015 en las tiendas Reebok o en: People Play’s, Planeta Sport, Branchos, X-Room, Footprints, Sport Life, Four Points y Sport Zone, en la ciudades Bogotá, Cali, Medellin y B/manga.</p>
					</div>
					<div class="step">
						<img src="/images/step-2.jpg">
						<p>RECIBIRÁS 5 PUNTOS por compras de productos Reebok o 10 puntos por compra de productos ZPump en facturas mayores a $100.000.</p>
					</div>
					<div class="step">
						<img src="/images/step-3.jpg">
						<p>ENTREGA LA FACTURA de compra a tu entrenador Reebok y reclama un obsequio.</p>
					</div>
				</div>
				<div class="banner">
					<div class="content">
						<p>SI ERES UNO DE LOS 50 ENTRENADORES DEL REEBOK ACADEMY, CONOCE LA MECÁNICA COMPLETA PARA CONVERTIRTE EN EMBAJADOR AQUÍ.</p>
						<a href="/mecanica" class="button">VER MECÁNICA <i class="arrow"></i></a>
					</div>
				</div>
				<div class="clear"></div>
			</div>
