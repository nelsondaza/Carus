	...
	<header>
		...
		<div class="body-zone">
			<nav id="mainMenu">
				...
				<ul class="menu">
					<li><a href="#" onclick="ga('send','event','Menu','select_Item','REEBOK ACADEMY')">REEBOK ACADEMY</a></li>
					<li><a href="#entrenadores" onclick="ga('send','event','Menu','select_Item','ENTRENADORES Y ASISTENTES')">ENTRENADORES Y ASISTENTES</a></li>
					<!--<li><a href="#">MAPA PUMP</a></li>
					<li><a href="#">APOYA A TU ENTRENADOR</a></li>-->
		...
		<div class="body-zone">
			<div class="banner">
				<div class="content">
					...
					<p>¡VIVE AQUÍ CADA MINUTO DEL REEBOK ACADEMY Y SÉ PARTE DE ESTA EXPERIENCIA!</p>
					<br><br>
			...
			<div class="trainers">
				<div class="banner">
					<div class="content">
						...
						<p>Conoce los 50 entrenadores de parque que hacen parte del <br>Reebok Academy.</p>
...
?>
	...
	<section class="products">
		<div class="body-zone">
			...
			<div class="list">
				<div class="product">
					<a href="http://www.reebok.co/zapatos-hombre" target="_blank" onclick="ga('send','event','Home','Productos',$(this).find('.name').text())">
				...
				<div class="product">
					<a href="http://www.reebok.co/zapatos-mujer" target="_blank" onclick="ga('send','event','Home','Productos',$(this).find('.name').text())">
